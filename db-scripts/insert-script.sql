INSERT INTO user (firstname, lastname, username, email, `password`, `role`, dateofbirth) VALUES
('John', 'Doe', 'johndoe', 'john.doe@example.com',  'hashed_password_1', 'admin', '1990-01-01'),
('Jane', 'Smith', 'janesmith', 'jane.smith@example.com', 'hashed_password_2', 'user', '1985-05-15'),
